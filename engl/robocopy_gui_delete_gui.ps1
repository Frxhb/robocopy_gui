...
function global:MainProgram {
    ...
    $global:handler_3_Click = {
        ...
        $RichTextBox1.AppendText("Starting job... `n `n")
        ...
        if (!$checkBox1.Checked -and !$checkBox2.Checked -and !$checkBox3.Checked -and !$checkBox4.Checked) {
            ...
            $RichTextBox1.ReadOnly = $false
            $RichTextBox1.AppendText("Process ID of process seems to be: $process_id`n`n")
            $RichTextBox1.ReadOnly = $true
        }
    ...
    function global:FormDefinition {
        ...
        $label1.Text = 'Choose Source folder:'
        ...
        $label2.Text = 'Choose Destination folder:'

        # label 3
        $label3 = New-Object System.Windows.Forms.Label
        $label3.Location = New-Object System.Drawing.Point(20, 230)
        ...
        # text of button 
        $Choose_Copy_Directory_Button.Text = 'Browse..'
        ...
        $CancelButton.Location = New-Object System.Drawing.Point(620, 450) #y und x Achse
        ...
        $start_job_button.Location = New-Object System.Drawing.Point(324, 450 ) #y und x Achse
        $start_job_button.Size = New-Object System.Drawing.Size(75, 23)
        $start_job_button.Text = 'start-job'
        ...
        $stop_job_button.Location = New-Object System.Drawing.Point(424, 450 ) #Y und x Achse
        $stop_job_button.Size = New-Object System.Drawing.Size(75, 23)
        $stop_job_button.Text = 'stop-job'
        ...
        $checkBox2.Text = "Also (empty) subdirectory (/E)"
        $System_Drawing_Point = New-Object System.Drawing.Point
        $System_Drawing_Point.X = 20
        $System_Drawing_Point.Y = 70
        ...
        $checkBox4.Text = "Delete Destination-folder contents"
        $System_Drawing_Point = New-Object System.Drawing.Point
        $System_Drawing_Point.X = 20
